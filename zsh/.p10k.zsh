# Generated by Powerlevel10k configuration wizard on 2024-07-10 at 20:33 ACST.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      '*global*'  GLOBAL    # These values are examples that are unlikely
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_FOREGROUND=160
  typeset -g POWERLEVEL9K_TERRAFORM_GLOBAL_FOREGROUND=160
